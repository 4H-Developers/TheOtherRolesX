...
namespace TheOtherRoles.Modules {
    public class CustomColors {
        ...
        public static void Load() {
            ...
            /* Custom Colors */
            colors.Add(new CustomColor { longname = "三文鱼",
                                        ...
                                        isLighterColor = true });
            colors.Add(new CustomColor { longname = "波尔多",
            ...
            colors.Add(new CustomColor { longname = "橄榄色",
                                        ...
                                        isLighterColor = false });
            colors.Add(new CustomColor { longname = "绿宝石",
            ...
            colors.Add(new CustomColor { longname = "薰衣草",
                                        ...
                                        isLighterColor = true });
            colors.Add(new CustomColor { longname = "牛轧糖",
            ...
            colors.Add(new CustomColor { longname = "芥末色",
                                        ...
                                        isLighterColor = false });
            colors.Add(new CustomColor { longname = "亮粉色",
